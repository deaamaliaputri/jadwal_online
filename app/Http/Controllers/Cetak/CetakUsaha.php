...
class CetakUsaha extends Controller
{
    protected $crud;
    protected $paginate;
    protected $akun;
...
//        array(215, 330)
        ...
        $pdf->SetAligns(['', 'J']);
        $pdf->Row2(['', 'menurut keterangan yang bersangkutan, mempunyai usaha '.$usaha->jenis_usaha. ' berlokasi di: ' .$usaha->lokasi_usaha.' '. $alamatlengkap1]);
        $pdf->Ln(5);
