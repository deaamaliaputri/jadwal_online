...
class CetakLaporanUsaha extends Controller
{
    protected $crud;
    protected $paginate;
//330 210
    ...
    function Cover($pdf, $id)
    {
        ...
        $pdf->Ln(10);
        $pdf->Cell(0, 5, 'SURAT KETERANGAN USAHA', 0, 0, 'C');
        $pdf->Ln(10);
...
//        echo $space_bottom . ' + ';
    ...
    function Column($pdf, $id)
    {
        ...
        $pdf->Cell(40, 20, 'Jenis Usaha', 1, 0, 'C');
        $pdf->Cell(38, 20, 'Alamat Usaha', 1, 0, 'C');
    ...
    function Column2($pdf)
    {
        ...
        $pdf->Ln(10);
        $pdf->Cell(0, 10, 'SURAT KETERANGAN USAHA', 0, 0, 'C');
        $pdf->Ln(10);
    }
...
//        array(215, 330)
        ...
        $this->Column2($pdf);
        $this->Column($pdf, $id);
        $jumlah = $this->usaha->getByPagecetak($id);
...
//                $this->butuh = true;
            ...
            $tanggal = $this->usaha->getByPagelimittanggal($id);
            if ($tanggal != null) {
