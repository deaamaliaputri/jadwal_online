app.controller('DepartmentsEditCtrl', ['$state', '$scope', 'departments', 'SweetAlert', 'toaster', '$stateParams', function ($state, $scope, departments, SweetAlert, toaster, mdToast, $stateParams) {
    ...
    $scope.updateData = function () {
        ...
        if ($scope.Form.$valid) {
            //run Ajax
            departments.update($scope.myModel)
                .success(function (data) {
