app.controller('DepartmentsEditCtrl', ['$state', '$scope', 'departments', '$mdToast', '$stateParams', function ($state, $scope, departments, $mdToast, $stateParams) {
    ...
    //get lass departments
    departments.getLastDepartments()
    ...
    departments.show($scope.id)
        .success(function (data) {
            ...
            $scope.input.departments = data.departments;
        });
    ...
    $scope.updateData = function () {
        ...
        if ($scope.editForm.$valid) {
            //run Ajax
            departments.update($scope.input)
                .success(function (data) {
                    if (data.success == true) {
