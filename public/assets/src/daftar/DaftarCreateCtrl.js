app.controller('DaftarCreateCtrl', ['$state', '$scope', 'daftar','$timeout', 'SweetAlert','toaster','$http', function ($state, $scope, daftar,$timeout, SweetAlert,toaster) {
