app.controller('DaftarEditCtrl', ['$state', '$scope', 'daftar', 'SweetAlert', 'toaster', '$stateParams', function ($state, $scope, daftar, SweetAlert, toaster, mdToast, $stateParams) {
